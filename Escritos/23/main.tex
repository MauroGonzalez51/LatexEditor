...
\author{\IEEEauthorblockN{1\textsuperscript{st} Valentina Del Rio}
	...
	\and
	\IEEEauthorblockN{2\textsuperscript{st} Juliana Arias}
	\IEEEauthorblockA{\textit{Universidad Tecnologica de Bolivar} \\
		\textit{UTB}\\
		Cartagena, Colombia \\
		thornej@utb.edu.co}
	...
	\and
	\IEEEauthorblockN{3\textsuperscript{st} Valentina Niño}
	\IEEEauthorblockA{\textit{Universidad Tecnologica de Bolivar} \\
		\textit{UTB}\\
		Cartagena, Colombia \\
		ninov@utb.edu.co}
	...
	\and
	\IEEEauthorblockN{4\textsuperscript{st} Maria Grau}
	\IEEEauthorblockA{\textit{Universidad Tecnologica de Bolivar} \\
		\textit{UTB}\\
		Cartagena, Colombia \\
		graum@utb.edu.co}
	...
	\and
	\IEEEauthorblockN{5\textsuperscript{st} Valeria Santamaria}
	\IEEEauthorblockA{\textit{Universidad Tecnologica de Bolivar} \\
		\textit{UTB}\\
		Cartagena, Colombia \\
