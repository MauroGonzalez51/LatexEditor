...
\includegraphics[width=0.9\linewidth]{./Images/Bobina.jpeg}

% -------------------------------------------|>
\subsection*{Sensor cassy}

Es un interfaz que sirve para recopilar datos. Este sensor
puede medir la diferencia de potencia eléctrica.

\includegraphics[width=0.7\linewidth]{./Images/Sensor.jpeg}

% -------------------------------------------|>
\subsection*{Fuente de alimentación}

\includegraphics[width=0.7\linewidth]{./Images/Fuente.jpeg}

% -------------------------------------------|>
\subsection*{Multímetro}

\includegraphics[width=0.7\linewidth]{./Images/Multimetro.jpeg}
